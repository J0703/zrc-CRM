...
<table width="100%" border="1">
    ...
    <c:forEach items="${dps}" var="department">
    <c:forEach items="${department.posts}" var="post">
    <tr>
        <td align="center">${department.depName}</td>
        <td align="center">${post.postName} </td>
        <td width="7%" align="center">
            <a href="${pageContext.request.contextPath}/findPostByPid.action?postId=${post.postId}"><img
